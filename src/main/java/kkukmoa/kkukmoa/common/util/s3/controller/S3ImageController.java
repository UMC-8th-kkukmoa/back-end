...
public class S3ImageController {
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(
                                    ...
                                    schema = @Schema(type = "string", example = "https://your-bucket.s3.ap-northeast-2.amazonaws.com/store/uuid.jpg"))
                    ),
                    @ApiResponse(
                            responseCode = "400",
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(
                                    mediaType = "text/plain",
                                    schema = @Schema(type = "string", example = "이미지 삭제 완료: https://your-bucket.s3..."))
                    ),
                    @ApiResponse(
                            responseCode = "400",
    ...
    public ResponseEntity<String> deleteImage(
            @Parameter(description = "삭제할 이미지의 S3 URL", required = true)
    ...
    @Operation(
            ...
            parameters = {
                    @Parameter(
                            name = "imageUrl",
                            description = "전체 이미지 주소 (예: https://kkukmoa-static-files.s3.ap-northeast-2.amazonaws.com/review/uuid.jpg)",
                            required = true,
                            example = "https://kkukmoa-static-files.s3.ap-northeast-2.amazonaws.com/review/abc.jpg"
                    )
            },
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(
                                    mediaType = "text/plain",
                                    schema = @Schema(type = "string", example = "https://kkukmoa-static-files.s3.ap-northeast-2.amazonaws.com/review/abc.jpg")
                            )
                    ),
                    @ApiResponse(
                            responseCode = "404",
