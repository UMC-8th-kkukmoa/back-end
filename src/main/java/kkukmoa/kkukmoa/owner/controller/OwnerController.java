...
public class OwnerController {
  ...
  @PatchMapping("/qrcode")
  @Operation(summary = "( 사장님 ) 고객 QR 코드 인식 후 처리 API",
            description = "QR 코드 정보를 받아 차감할 금액을 반환합니다. 금액 차감에 성공하면<br>"
  ...
  @Operation(summary = "( 사장님 ) 스탬프 적립 QR 코드 발급·조회 API",
            description = "고객에게 보여줄 스탬프 적립용 QR 코드를 발급 받는 API 입니다.<br>"
