...
public class RedisPaymentPrepareRepository {
    ...
    public void save(PaymentRequestDto.PaymentPrepareRequestDto request) {
        redisTemplate.opsForValue().set(PREFIX + request.getOrderId(), request, Duration.ofMinutes(10));
    }
    ...
    public Optional<PaymentRequestDto.PaymentPrepareRequestDto> findByOrderId(String orderId) {
        ...
        PaymentRequestDto.PaymentPrepareRequestDto dto = objectMapper.convertValue(raw, PaymentRequestDto.PaymentPrepareRequestDto.class);
