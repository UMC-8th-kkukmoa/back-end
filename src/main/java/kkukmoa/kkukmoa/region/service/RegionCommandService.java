...
public class RegionCommandService {
    ...
    public Region createRegion(String address, String detailAddress, double latitude, double longitude) {
        return regionRepository
                .findByAddressAndDetailAddressAndLatitudeAndLongitude(address, detailAddress, latitude, longitude)
                .orElseGet(() -> createIfAbsent(address, detailAddress, latitude, longitude));
    }

    private Region createIfAbsent(String address, String detailAddress, double latitude, double longitude) {
        try {
