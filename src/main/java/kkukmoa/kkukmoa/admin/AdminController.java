...
public class AdminController {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "가게 없음(STORE4001)"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 상태 전환 또는 이미 승인됨(STORE4101/STORE4004)")
    })
    ...
    public ResponseEntity<ApiResponse<String>> approve(@PathVariable Long storeId) {
        ...
        return ResponseEntity
                ...
                .body(ApiResponse.onSuccess("입점 신청이 승인되었습니다."));
    }
}