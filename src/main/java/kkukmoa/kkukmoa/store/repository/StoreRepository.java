...
public interface StoreRepository extends JpaRepository<Store, Long> {
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    Page<Store> findWithinRadiusPoint(@Param("lat") double lat,
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    Page<Store> findWithinRadiusPointByCategory(@Param("categoryId") Long categoryId,
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    Page<Store> findWithinRadiusPointByName(@Param("name") String name,
                                            @Param("lat") double lat,
                                            @Param("lon") double lon,
                                            @Param("radiusMeters") double radiusMeters,
                                            Pageable pageable);
