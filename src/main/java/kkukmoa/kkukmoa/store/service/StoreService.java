...
public interface StoreService {
    ...
    StorePagingResponseDto<StoreListResponseDto> getStores(double latitude, double longitude, int page, int size);
    ...
    StorePagingResponseDto<StoreListResponseDto> searchStoresByName(String name, double latitude, double longitude, int page, int size);
}
